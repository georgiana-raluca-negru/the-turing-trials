    ...
    <div className="flex flex-col items-center justify-center flex-grow p-4 min-h-[calc(100vh-57px)] bg-[rgb(var(--bg-page))]">
      <div className="w-full max-w-md bg-[rgb(var(--bg-surface))] rounded-2xl border border-[rgb(var(--border-sub))] shadow-lg p-8">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          {[
            { id: "username", label: "Agent_Alias (Username)", type: "text", value: username, set: setUsername, placeholder: "NeonLawyer99" },
            { id: "email",    label: "User_Email",             type: "email", value: email, set: setEmail, placeholder: "agent@turing.net" },
            { id: "password", label: "Assign_Password",        type: "password", value: password, set: setPassword, placeholder: "••••••••" },
